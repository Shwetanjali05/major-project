...
const Profile = () => {
  const [profileImage, setProfileImage] = useState('/images/user/userimage.jpg');
      ...
      <div className="mx-auto max-w-242.5">
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              <div className="relative drop-shadow-2 rounded-full overflow-hidden">
                <Image
                  ...
                  className="rounded-full" // Ensure image is displayed as a circle
                  alt="profile"
                />
                <label
                  htmlFor="profile"
            ...
            <div className="mt-4">
              <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white">InvestwiseUser</h3>
